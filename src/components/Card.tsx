  ...
  return (
    <>
      <div
        ...
        class="bg-white cursor-pointer aspect-square p-5 border border-solid border-gray-200 rounded-xl shadow-sm duration-500 transition-all hover:scale-105 hover:shadow-lg"
      >
